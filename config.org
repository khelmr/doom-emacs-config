...
#+end_src
** Consult
*** Replace =flymake-list-errors= with =consult-flymake=
#+begin_src emacs-lisp :tangle yes
(map! :after flycheck [remap flycheck-list-errors] #'consult-flycheck)
#+end_src
...
(use-package! zotra
  :after citar
  :config
  (setq zotra-default-bibliography citar-bibliography))
#+end_src
*** COMMENT Pubmed
#+begin_src emacs-lisp :tangle packages.el
(package! pubmed)
...
(after! gptel
  (setq gptel-model   'deepseek-r1:latest
      ...
      gptel-default-mode 'org-mode))
#+end_src
*** COMMENT Add Open evidence backend
#+begin_src emacs-lisp :tangle yes
(after! gptel
  (gptel-make-ollama "OpenEvidence"
    :host "api.openevidence.com"
...
(use-package! org-timeblock
  :after org)
#+end_src
**** COMMENT Org checkbox
#+begin_src emacs-lisp :tangle packages.el
(package! org-checkbox)
#+end_src

#+begin_src emacs-lisp :tangle yes
(use-package! org-checkbox
  :after org)
#+end_src
*** Capture
**** Doct
...
***** Add image note
#+begin_src emacs-lisp :tangle no
(defun +org-noter-add-region-image
    "asdfsdf"
  (interactive "P")
  ...
  (let* ((ast (org-noter--parse-root)) (contents (org-element-contents ast))
         ...
         (selected-region ())
         (location (org-noter--doc-approx-location (or precise-info 'interactive) )))))
#+end_src
